...
# If we see a little more closely, we see that in most of the parameters
# the default arguments are provided using '='. Lets see then one by one
...
# Similarly for file=sys.stdout and flush=False) are the default
# arguments.
